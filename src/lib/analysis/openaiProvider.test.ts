...
const CFG = { apiKey: "sk-x", model: "gpt-4o-mini", modelId: "openai:gpt-4o-mini:ja-tags-v4", timeoutMs: 20000 };
...
describe("createOpenAIProvider", () => {
  it("returns the parsed JSON body only (modelId is the composite id)", async () => {
    ...
    expect(provider.modelId).toBe("openai:gpt-4o-mini:ja-tags-v4");
