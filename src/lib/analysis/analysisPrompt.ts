...
- 次の大カテゴリから、テキストで明確に読み取れるものだけを選ぶ。優先順位は上から順:
  ...
  2. 衣装（具体的な語のみ）: 水着 / ランジェリー / ドレス / スーツ / 制服 / 和装 / 部屋着 / コート
  3. 場所（具体的な語のみ）: 海 / プール / ビーチ / ベッド / 浴室 / テラス / カフェ / 街中 / 自然 / スタジオ / ホテル / 部屋
  4. 構図（画像間で差が出るものだけ）: 全身 / 上半身 / 横顔 / 後ろ姿 / 手元 / クローズアップ / バストアップ
  5. 光・環境: 逆光 / 室内光 / 暖色光 / 日差し / 夕景
  6. 被写体: 料理 / 商品 / 風景 / 建物 / 小物 / 動物 / 犬 / 猫
  7. 雰囲気（最大1件・任意）: 高級感 / クール
- 上記カテゴリの語をそのまま使う。「〜の描写」「〜の背景」「〜のシーン」「〜な雰囲気」「肌の質感」「エアリー」「ミニマル」などの細かい描写・主観的な語は出さない。
- 「人物」「ポートレート」は出さない（ほぼ全画像に該当し、絞り込みに使えないため）。
- 汎用すぎるタグ・抽象的な雰囲気タグは出さない。具体的なタグを優先する。次のタグは出さない: 自然光 / ナチュラル / シンプル / 室内 / 屋外 / 私服 / リラックス。
  - 場所は「室内」ではなく、テキストで明示されている場合のみ「部屋」「ホテル」「スタジオ」「カフェ」などの具体的な場所語を使う。
  - 場所は「屋外」ではなく、テキストで明示されている場合のみ「海」「プール」「ビーチ」「街中」「自然」「テラス」などの具体的な場所語を使う。
  - 衣装は「私服」のような大雑把な語は使わない。テキストで明示されている場合のみ「ドレス」「スーツ」「制服」「和装」「部屋着」「コート」「水着」「ランジェリー」などの具体的な衣装語を使う。
