...
export default function QuickAddHeader({ workspaceName, userEmail, itemCount, sessionId }: Props) {
  return (
    <header className="flex items-center gap-4 border-b border-zinc-200 bg-white px-4 py-3">
      ...
      <a href="/gallery" className="text-sm text-zinc-500 hover:text-zinc-900">Gallery</a>
      <a href="/masters" className="text-sm text-zinc-500 hover:text-zinc-900">Masters</a>
      <a href="/import" className="text-sm text-zinc-500 hover:text-zinc-900">Import</a>
